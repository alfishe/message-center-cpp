...
// Emulator-optimized dual-queue system:
// - Fast queue: Inline-only, zero allocation, for time-critical events
// - Bulk queue: Managed payloads, for debug/state data
//
// Fast queue handles: audio sync, vblank, input, frame pointers
// Bulk queue handles: debug traces, screenshots, state saves
