...
| `src/objectpool_threadlocal.h` | Thread-local object pool (experimental) | ~98 |
| `src/payload_refcounted.h` | Zero-copy ref-counted payload | ~100 |
| `src/eventqueue_lockfree.h` | Lock-free EventQueue variant | ~100 |
| `src/eventqueue_broadcast.h` | Fire-and-forget broadcast queue | ~230 |
| `src/eventqueue_broadcast_fast.h` | Maximum performance variant | ~175 |
| `src/eventqueue_broadcast_fast_tl.h` | Thread-local pool variant (experimental) | ~155 |
| `src/eventqueue_broadcast_fast_batch.h` | Batch dispatch variant | ~235 |
| `src/eventqueue_broadcast_fast_prefetch.h` | Prefetch hints variant | ~210 |
| `src/eventqueue_emulator.h` | Dual-queue emulator-optimized variant | ~280 |
| `benchmarks/realworld_benchmark.cpp` | Comprehensive latency benchmarks | ~1800 |
